    ...
    return (
        <div className="dropdown" style={{ cursor: 'pointer' }}>
            ...
            <ul id="submitReviewRating" className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li>
                    <button onClick={() => starValue(2)} className="dropdown-item">2 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(2.5)} className="dropdown-item">2.5 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(3)} className="dropdown-item">3 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(3.5)} className="dropdown-item">3.5 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(4)} className="dropdown-item">4 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(4.5)} className="dropdown-item">4.5 stars</button>
                </li>
                <li>
                    <button onClick={() => starValue(5)} className="dropdown-item">5 star</button>
                </li>
            ...
            {displayInput && 
                <form method="POST" action="#">
                    ...
                    <div>
                        <button type="button" className="btn btn-primary mt-3" onClick={() => props.submitReview(starInput, reviewDescription)}>
                            Submit Review
                        </button>
                    </div>
                </form>
