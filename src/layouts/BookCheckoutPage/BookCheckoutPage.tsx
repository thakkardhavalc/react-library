...
export const BookCheckoutPage = () => {
    ...
    const [isLoadingCurrenrLoanCount, setIsLoadingCurrentLoanCount] = useState(true);
    ...
    if (isLoading || isLoadingReview || isLoadingCurrenrLoanCount || isLoadingBookCheckedOut || isLoadingUserReview) {
        return (
            <SpinnerLoading />
        )
    }
