        ...
        <div className='container'>
            {fees > 0 &&
                <div className='card mt-3'>
                    ...
                    <div className='card-body'>
                        ...
                        <button disabled={submitDisabled} type='button' className='btn btn-md btn-primary text-white mt-3' onClick={checkout}>
                            Pay fees
                        </button>
                    </div>
                </div>
            ...
            {fees === 0 &&
                <div className='mt-3'>
                    ...
                    <Link type='button' className='btn btn-primary text-white' to='/search'>
                        Explore top books
                    </Link>
                </div>
            }
