...
export const DisplayChangeQuantityOfBook: FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    useEffect(() => {
        const fetchBookInState = () => {
            ...
            props.book.copiesAvailable ? setRemainings(props.book.copiesAvailable) : setRemainings(0);
        };
        fetchBookInState();
    }, []);
    ...
    async function increseQuantity() {
        ...
        setRemainings(remainings + 1);
    }

    async function decreseQuantity() {
        ...
        <div className="card mt-3 shadow p-3 mb-3 bg-body rounded">
            <div className="row g-0">
                ...
                <div className="mt-3 col-md-4">
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                        <p>Books Remaining: <b>{remainings}</b></p>
                    </div>
                </div>
                ...
                <button className="m1 btn btn-md btn-primary text-white" onClick={increseQuantity}>
                    Add Quantity
                </button>
                <button className="m1 btn btn-md btn-warning" onClick={decreseQuantity}>
                    Decrease Quantity
                </button>
            </div>
        </div>
