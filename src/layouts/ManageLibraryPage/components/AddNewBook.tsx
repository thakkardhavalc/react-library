...
export const AddNewBook = () => {
    ...
    async function submitNewBook() {
        ...
        if (authState?.isAuthenticated && title!== "" && author!== "" && 
            description!== "" && copies!== 0 && category!== "") {
                const bookRequestModel: AddBookRequest = new AddBookRequest(title, author, description, copies, category);
                bookRequestModel.img = selectedImg;
                ...
                const requestOptions = {
                    ...
                    body: JSON.stringify(bookRequestModel)
                };
